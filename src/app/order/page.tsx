...
export const metadata: Metadata = {
  ...
  description:
    "Избери пакет барчета ТЕПЕ bite. 10, 20 или 35 барчета с солен карамел от Пловдив.",
};
          ...
          >
            ...
            <div
              style={{
                ...
                inset: 0,
                background:
                  "linear-gradient(to right, oklch(32% 0.09 315 / 0.82) 10%, oklch(32% 0.09 315 / 0.3) 55%, transparent 100%)",
                display: "flex",
                alignItems: "center",
            ...
            >
              <div>
                <div
                  className="label-tag"
                  style={{ color: "oklch(85% 0.08 55)", marginBottom: 8 }}
                >
                  Местно производство
                </div>
                <div
          ...
          {dbUnavailable && (
            ...
            >
              ...
              <p style={{ fontSize: "0.9rem", margin: 0 }}>
                Подготвяме системата за поръчки. Следи ни в социалните мрежи за
                последна информация.
              </p>
            </div>
          )}
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 24 }}>
                ...
                >
                  ...
                  <span style={{ color: "var(--text-mid)" }}>
                    ...
                    до Speedy автомат при поръчка над €30
                  </span>
                </div>
                <div
                  style={{
