  ...
  bg: [
    {
      ...
      copy: "Идеята и реализацията е от група пловдивски младежи по случай Teenovator 2026. Продуктът е произведен в Пловдивска област, а с част от реализираната печалба се осъществяват проекти в обществена полза за града.",
    },
    {
      icon: <IconLeaf />,
      title: "Ясен и прозрачен състав",
      copy: "Ядки, семена, фибри, растителен протеин, лукума, еритритол и морска сол — без излишна сложност. Произведено от сертифициран производител (BioStyle LTD), който вярва във важността на устойчивите практики в бизнеса.",
    },
    {
      icon: <IconStar />,
