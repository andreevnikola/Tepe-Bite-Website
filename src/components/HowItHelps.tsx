...
const steps = {
  bg: [
    ...
    },
    {
      ...
      copy: 'Показваме напредъка, събраните средства и реализираните действия в нашето пространство за инициативи.',
    },
  ],
  en: [
    {
    ...
    },
    {
      ...
      copy: 'We show progress, funds raised and actions taken in our initiative space.',
    },
  ],
};
      ...
      <div className="section-inner">
        <div style={{ textAlign: 'center', marginBottom: 60 }}>
          ...
          <h2 className="heading-lg">
            {lang === 'bg' ? 'Как всяка покупка помага' : 'How Every Purchase Helps'}
          </h2>
        </div>
          ...
          {items.map((s, i) => (
            ...
            >
              ...
              >
                ...
                <p style={{ fontSize: '0.93rem', maxWidth: 240, margin: '0 auto' }}>
                  {s.copy}
                </p>
              </div>
              {i < items.length - 1 && (
