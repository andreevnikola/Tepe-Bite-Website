export const IconLeaf = () => (
  ...
  >
    <path d="M2 22s4-2 8-8c2-3 3-7 2-10-4 1-7 4-8 8-1 2-1 6 0 8" />
    <path d="M22 2s-2 4-8 8c-3 2-7 3-10 2 1-4 4-7 8-8 2-1 6-1 8 0" />
  </svg>
);
...
// Hamburger ↔ X morph — same three-line hamburger as IconMenu, but the
// lines rotate/translate/fade into an X in place rather than hard-swapping
// to IconClose. Driven by the `open` prop; motion lives in globals.css
// (`.tb-hb-*`) so it shares the site's one reduced-motion guard.
export const IconMenuToggle = ({ open }: { open: boolean }) => (
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
    ...
    strokeWidth="2"
    strokeLinecap="round"
    className={`tb-hb${open ? " tb-hb-open" : ""}`}
  >
    <line x1="3" y1="6" x2="21" y2="6" className="tb-hb-line tb-hb-top" />
    <line x1="3" y1="12" x2="21" y2="12" className="tb-hb-line tb-hb-mid" />
    <line x1="3" y1="18" x2="21" y2="18" className="tb-hb-line tb-hb-bottom" />
  </svg>
);
