...
import { IconLeaf, IconMap, IconHeart } from '@/components/icons';
  ...
  return (
    ...
    >
      <div className="section-inner" style={{ textAlign: 'center' }}>
        ...
        <h2 className="heading-lg" style={{ maxWidth: 640, margin: '0 auto 20px' }}>
          {lang === 'bg'
            ? 'Не просто барче. Малък начин да подкрепиш нещо по-голямо.'
            : 'Not just a bar. A small way to support something bigger.'}
        </h2>
        <p style={{ maxWidth: 580, margin: '0 auto 48px', fontSize: '1.05rem' }}>
          {lang === 'bg' ? (
            <>
              <strong>
                Създадохме ТЕПЕ bite като продукт, който съчетава вкус, качество и
                кауза.
              </strong>{' '}
            ...
            <>
              <strong>
                We created ТЕПЕ bite as a product that combines taste, quality and
                purpose.
              </strong>{' '}
        ...
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                'linear-gradient(to right, oklch(32% 0.09 315 / 0.55) 0%, transparent 50%)',
              display: 'flex',
              alignItems: 'center',
          ...
          >
            <div>
              ...
              >
                {lang === 'bg' ? 'Ръчно производство' : 'Handcrafted'}
              </div>
              <p
                style={{
                  color: 'white',
              ...
              >
                {lang === 'bg'
                  ? 'Всяко барче е направено с грижа в Пловдив'
                  : 'Every bar is made with care in Plovdiv'}
              </p>
            </div>
          </div>
        </div>
        ...
        >
          {items.map((p, i) => (
            <div
              ...
              style={{ padding: '40px 32px', textAlign: 'left' }}
            >
              <div
                style={{
                  width: 48,
              ...
              <h3 className="heading-md" style={{ marginBottom: 12, fontSize: '1.2rem' }}>
                {p.title}
              </h3>
